...
Hamburg is the best challenger/second test: it has the highest survey-reported city-level intent (7.52/10), the highest share of high-intent respondents (45.8%), and the highest purchase frequency among named cities (6.32/month), but its modeled market share is 10% versus Berlin's 18%. The recommendation therefore prioritizes Berlin's scale while using Hamburg as a validation cell; it does not claim Berlin will have the highest conversion.
...
- Applying the file's illustrative 2026 city shares to €2.548bn gives a **directional market-opportunity estimate** of: **Berlin €458.6m (18%)**, **Munich €382.2m (15%)**, **Hamburg €254.8m (10%)**, **Cologne €229.3m (9%)**, and **Frankfurt €203.8m (8%)**. These are calculated sizing metrics, not observed city sales or LUMEN sales forecasts.
